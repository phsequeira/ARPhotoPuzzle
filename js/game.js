{
    const image = new Image(),
        ...
        numCol = 3, numRow = 3, puzzlePieces = numCol * numRow, tolerance = 1.9;
        ...
        //Displays the stream from the camera, and then create an imageCapture object using video from stream
        ...
        const createImagePieces = image => {
            ...
            const pieceHeight = image.heigth / numRow;

            for (let x = 0; x < numCol; ++x) {
                for (let y =0; y < numRow; ++y) {
                    ctx.drawImage(image, x * pieceWidth, y * pieceHeight, pieceWidth, pieceHeight, 0, 0, canvas.width, canvas.heigth)
